		...
		if col_ray and alive(col_ray.unit) then
			...
			elseif self._on_melee_restart_drill and hit_unit:base() and hit_unit:base().is_drill then
				...
				elseif special_weapon == "taser" then
					if self._melee_tase_cooldown == 0.0 then
			...
			if character_unit:character_damage() and character_unit:character_damage().damage_melee then
				...
				if special_weapon == "taser" and self._melee_tase_cooldown == 0.0 then
					action_data.variant = "taser_tased"
					self._melee_tase_cooldown = 15
				end
